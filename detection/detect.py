...
parser.add_argument('-e', '--enhancement', action='store', choices=['eganjt','zdce','mbllen','original', 'iat'], 
...
if __name__=="__main__":
    ...
    while cap.isOpened():
        ...
        if args.output is not None and (frame < 22501):
            vid_writer.write(enhanced_image)

        if (cv2.waitKey(1) & 0xFF == 27) or (frame > 22500):
