...
SOURCE_VIDEO1 = "./output_videos/singapore_original_output.mp4"
SOURCE_VIDEO2 = "./output_videos/singapore_eganjt_output.mp4"
SOURCE_VIDEO3 = "./output_videos/singapore_zdce_output.mp4"
SOURCE_VIDEO4 = "./output_videos/singapore_iat_output.mp4"
...
if __name__=="__main__":
    ...
    OUTPUT_VIDEO = "./output_videos/"+"singapore_combined_output.mp4"
